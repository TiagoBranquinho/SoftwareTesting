...
public class JumperMovementTest {
    ...
    void testStep_MovesMonsterToValidPosition() throws IOException {
        ...
        jumperMovement.step(mockMonster, mockArena, 200, 0);
    ...
    void testStep_NoMoveDueToDelay() throws IOException {
        ...
        jumperMovement.step(mockMonster, mockArena, 199, 0); // Not enough time has passed
    ...
    void testMoveMonster_CollidesWithIceCream() {
        ...
        jumperMovement.moveMonster(mockMonster, monsterPosition, mockArena);
