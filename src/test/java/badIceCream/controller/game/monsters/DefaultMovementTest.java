...
public class DefaultMovementTest {
    ...
    void testStep_MovesMonsterToValidPosition() throws IOException {
        ...
        defaultMovement.step(mockMonster, mockArena, 225, 0);
    ...
    void testStep_NoMoveDueToDelay() throws IOException {
        ...
        defaultMovement.step(mockMonster, mockArena, 224, 0); // Not enough time has passed
    ...
    void testMoveMonster_CollidesWithIceCream() {
        ...
        defaultMovement.moveMonster(mockMonster, monsterPosition, mockArena);
