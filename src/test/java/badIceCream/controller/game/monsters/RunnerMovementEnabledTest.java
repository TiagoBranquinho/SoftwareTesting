...
public class RunnerMovementEnabledTest {
    ...
    private RunnerMovementEnabled runnerMovement;
    ...
    @BeforeEach
    void setUp() {
        runnerMovement = new RunnerMovementEnabled();
    ...
    void testStep_MovesMonsterToValidPosition() throws IOException {
        ...
        runnerMovement.step(mockMonster, mockArena, 5, 0);
    ...
    void testStep_NoMoveDueToDelay() throws IOException {
        ...
        runnerMovement.step(mockMonster, mockArena, 4, 0); // Not enough time has passed
